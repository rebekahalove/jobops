import { AdminUsersManager } from "../../../../../jobops/components/admin-users";
import { getCurrentJobOpsSession } from "../../../../../jobops/lib/jobops-session";

export default async function MountedAdminUsersPage() {
  ...
  return <AdminUsersManager apiBasePath="/jobops/api" currentUserId={session.user.id || ""} />;
}
